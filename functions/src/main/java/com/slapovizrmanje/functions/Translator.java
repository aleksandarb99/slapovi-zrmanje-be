...
public class Translator {
  ...
  public static final Translator germanTranslations = Translator.builder()
          .hello("Hallo")
          .reserveHello("Hallo, noch einmal Ihre Anforderungszusammenfassung")
          .bye("Mit freundlichen Grüßen")
          .verifyButton("Anforderung überprüfen")
          .reserveButton("Reservieren")
          .cancelButton("Abbrechen")
          .reserveText("Anfrage wurde akzeptiert. Reservieren Sie jetzt Ihre %s Anfrage!")
          .verifyText("Überprüfen Sie Ihre %s Anfrage!")
          .verifyConfirmText("Anfrage %s erfolgreich bestätigt")
          .reserveConfirmText("Anfrage %s erfolgreich reserviert")
          .cancelConfirmText("Reservierung %s erfolgreich abgebrochen")
          .rejectConfirmText("Anfrage für %s wurde abgelehnt")
          .verifyConfirmParagraph("Ihre %s Anforderungsnummer - <b>%s</b> wurde erfolgreich bestätigt ✅ Sie können bald mit dem Feedback rechnen.")
          .reserveConfirmParagraph("Ihre %s Anforderungsnummer - <b>%s</b> wurde erfolgreich reserviert ✅ Bis bald!\nFalls Sie aus irgendeinem Grund nicht kommen können, informieren Sie uns bitte, indem Sie Ihre Reservierung über die unten stehende Schaltfläche stornieren.")
          .cancelConfirmParagraph("Ihre %s Reservierungsnummer - <b>%s</b> wurde erfolgreich storniert ✅ Hoffentlich sehen wir uns nächstes Mal.")
          .rejectConfirmParagraph("Ihre %s Anforderungsnummer - <b>%s</b> wurde abgelehnt. Wahrscheinlich sind die gewählten Tage nicht verfügbar. Sie können heute Abend eine E-Mail mit vorgeschlagenen verfügbaren Zeiträumen erwarten. Vielen Dank für Ihre Geduld!")
          .notification("Benachrichtigung")
          .camp("Camp")
          .apartment("Wohnung")
          .lodgingApartment("Wohnung")
          .room("Zimmer")
          .lodgingRoom("Zimmer")
